...
namespace SharpSQLPwn.Utilities
{
    public class Functions
    {
        ...
        public static void CmdExec(SqlConnection con, int cmdExec_tech, string cmdExec_command)
        {
            ...
            if (cmdExec_command != null)
            {
                ...
                if (cmdExec_tech == 2)
                {
                    ...
                    Console.ResetColor();
                    String destroy_oa = "EXEC sp_OADestroy 'wscript.shell';";
        ...
        public static void TestLinkedServer(SqlConnection con, string linkedSQLServer, string smb_ip, string cmdExeclinked)
        {
